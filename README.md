...
<img src="https://raw.githubusercontent.com/CUBOT-robomaster/astrbot_plugin_robomaster_assistant/main/logo.png" width="256" alt="icon">
...
更推荐使用上面的自动下载方式。如果你想手动维护 PDF，可以在配置页面进入 **规则手册** -> **规则手册检索**，填写 **规则手册 PDF 目录**，然后把 PDF 放进那个目录，再发送：

```text
重建规则手册索引
```

如果不填写自定义目录，插件会优先使用自动下载的手册目录；自动下载目录为空时，才会兼容扫描 `data/rm_manuals`。
