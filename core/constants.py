...
CONFIG_GROUPS = {
    ...
    "forum_fetch_mode": ("forum_monitor", "forum_crawler"),
    "forum_http_timeout_seconds": ("forum_monitor", "forum_crawler"),
    "forum_detail_css_selector": ("forum_monitor", "forum_crawler"),
